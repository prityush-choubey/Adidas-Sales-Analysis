...
4. Business and operations analysis using SQL-style aggregations  
5. Interactive dashboard development in Power BI using DAX  
...
- Monthly sales trends by retailer

### 2. Channel Performance
- Sales and profit comparison across sales methods
- Profit per unit by channel
- Regional and city-level performance analysis

### 3. Product Performance
- Profit per unit by product category
- Product and retailer contribution analysis
- Monthly and regional profitability insights
